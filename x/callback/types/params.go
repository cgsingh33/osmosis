...
var (
	...
	DefaultMinPriceOfGas                  = sdk.NewCoin(sdk.DefaultBondDenom, sdkmath.ZeroInt())
)
...
func NewParams(
	...
	blockReservationFeeMultiplier sdkmath.LegacyDec,
	futureReservationFeeMultiplier sdkmath.LegacyDec,
